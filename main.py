...
output_dinner_label = ttk.Label(master = window, 
                         text = 'Dinner', 
                         font = OUTPUT_FONT, 
                         textvariable = output_dinner_string)
header_dinner_label = ttk.Label(master= window,
                            text = "Activity 1", 
                            font = HEADER_FONT)
output_dinner_label.pack(side= 'bottom', pady = 15, padx = 5)
header_dinner_label.pack(side= HEADER_SIDE, padx= 15)

output_activity_string = tk.StringVar()
output_activity_label = ttk.Label(master = window, 
                         text = 'Activity', 
                         font = OUTPUT_FONT, 
                         textvariable = output_activity_string)
header_activity_label = ttk.Label(master= window,
                            text = "Activity 2", 
                            font = HEADER_FONT)
output_activity_label.pack(side= 'bottom', pady = 15, padx = 5)
header_activity_label.pack(side= HEADER_SIDE, padx= 15)

output_desert_string = tk.StringVar()
output_desert_label = ttk.Label(master = window, 
                         text = 'output', 
                         font = OUTPUT_FONT, 
                         textvariable = output_desert_string)
header_desert_label = ttk.Label(master= window,
                            text = "Activity 3", 
                            font = HEADER_FONT)
output_desert_label.pack(side= 'bottom', pady = 15, padx = 5)
header_desert_label.pack(side= HEADER_SIDE, padx= 15)
